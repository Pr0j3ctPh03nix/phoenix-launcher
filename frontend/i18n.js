...
const I18N = {
  en: {
    ...
    "set.mirrorsHint": "Sorted fastest first. Click one to use it — your choice is kept until you test again, or until it goes offline. The list is published: mirrors are added to the main source, never instead of it, and it refreshes on launch.",
    "set.mirrorsEmpty": "No mirrors published yet.",
    "btn.mirrorSweep": "Test all & pick fastest",
    "btn.mirrorSweeping": "Testing…",
    "set.mirrorSweepHint": "Downloads a real file from each — a server can answer and still be unable to deliver.",
    "set.mirrorAuto": "Switch to the best automatically",
    "set.mirrorAutoHint": "When a new mirror is published, test everything and use the fastest. Off: new mirrors are listed but nothing is tested until you ask.",
    "mirror.untested": "not tested",
    "mirror.allDown": "No source could deliver anything — including the main one. Your choice has been kept; try again when the connection is back.",
    "mirror.primary": "Main source",
    "mirror.primaryHint": "Built in. Can't be removed.",
  ...
  ru: {
    ...
    "set.mirrorsHint": "Отсортированы по скорости. Нажмите на любой, чтобы использовать его — выбор сохранится до следующей проверки или пока зеркало не отключится. Список публикуется: зеркала добавляются к основному источнику, а не заменяют его, и обновляется при запуске.",
    "set.mirrorsEmpty": "Зеркала пока не опубликованы.",
    "btn.mirrorSweep": "Проверить и выбрать быстрейший",
    "btn.mirrorSweeping": "Проверка…",
    "set.mirrorSweepHint": "Качает с каждого настоящий файл — сервер может отвечать и всё равно не отдавать данные.",
    "set.mirrorAuto": "Автоматически переключаться на лучший",
    "set.mirrorAutoHint": "При появлении нового зеркала проверить все и использовать самый быстрый. Выкл: новые зеркала просто попадают в список, проверка — вручную.",
    "mirror.untested": "не проверено",
    "mirror.allDown": "Ни один источник не смог отдать данные — включая основной. Ваш выбор сохранён; попробуйте снова, когда связь восстановится.",
    "mirror.primary": "Основной источник",
    "mirror.primaryHint": "Встроенный. Нельзя удалить.",
